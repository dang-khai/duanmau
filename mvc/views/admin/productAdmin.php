...
<body class="d-flex ">
    <div class="d-flex flex-column flex-shrink-0 p-3 text-dark vh-100 position-relative"
        style="width: 250px; background-color: #FCB000;">
    ...
    <section class="container-fluid d-block">
        ...
        <a href="addProduct" class="ms-5 ">
            <button class="btn btn-primary">Thêm sản phẩm</button>
        </a>
        <div id="container" class=""></div>
        <table class="table table-bordered text-center mx-auto" id="table"
            style="width: 93%">
            <thead>
                <tr>
                    <th scope="col">STT</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <img src="/duanmau/public/picture/<?php echo $row['product_img'] ?>" class="w-25"> </td>
                    <td><?php echo $row['product_price']?></td>
                    <td><?php echo $row['mota']?></td>
                    <td>
                        <a href="edit/<?php echo $row['id']?>"> <button class="btn btn-primary">Sửa</button></a>
                        <a href="deleteProductHandle/<?php echo $row['id'] ?>"
